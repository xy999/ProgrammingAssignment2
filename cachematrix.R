...
#  The "makeCacheMatrix" function creates a special "vector", which is really a list containing a function to do the
#  following: set the value of the vector; get the value of the vector; set the value of the mean; and get the value of the 
#  mean.
...
# Calculates the mean of the special "vector" created with the preceding function. But first, it checks to see if the
# mean has already been calculated. If so, it gets the mean from the cache and skips the computation. Otherwise, it 
